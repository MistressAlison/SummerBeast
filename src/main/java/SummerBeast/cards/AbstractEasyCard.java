...
import SummerBeast.util.CardArtRoller;

import java.util.ArrayList;

import static SummerBeast.SummerBeastMod.*;
import static SummerBeast.util.Wiz.atb;
import static SummerBeast.util.Wiz.att;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target, SummerBeast.Enums.PACIFIC_BLUE_COLOR);
    }
