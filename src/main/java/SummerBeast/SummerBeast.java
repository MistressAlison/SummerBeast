...
import SummerBeast.cards.Defend;
import SummerBeast.cards.Strike;
import SummerBeast.relics.TodoItem;
import kobting.friendlyminions.characters.AbstractPlayerWithMinions;
import kobting.friendlyminions.characters.CustomCharSelectInfo;

import java.util.ArrayList;

import static SummerBeast.SummerBeast.Enums.PACIFIC_BLUE_COLOR;
import static SummerBeast.SummerBeastMod.*;

public class SummerBeast extends AbstractPlayerWithMinions {
    ...
    static final String ID = makeID("SummerBeast");
    static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString(ID);
    static final String[] NAMES = characterStrings.NAMES;
    static final String[] TEXT = characterStrings.TEXT;


    public SummerBeast(String name, PlayerClass setClass) {
        super(name, setClass, orbTextures, modID + "Resources/images/char/mainChar/orb/vfx.png", null, new SpriterAnimation(
    ...
    public AbstractCard.CardColor getCardColor() {
        return PACIFIC_BLUE_COLOR;
    }

    @Override
    public Color getCardTrailColor() {
        return PACIFIC_BLUE.cpy();
    }
    ...
    public AbstractPlayer newInstance() {
        return new SummerBeast(name, chosenClass);
    }
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_SUMMER_BEAST;
        @SpireEnum(name = "PACIFIC_BLUE_COLOR")
        public static AbstractCard.CardColor PACIFIC_BLUE_COLOR;
        @SpireEnum(name = "PACIFIC_BLUE_COLOR")
